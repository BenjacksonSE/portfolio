      ...
      <div className={classes.content}>
        <div className={classes.content__text}>
          ...
          <div className={classes.linkContainer}>
            <a href='https://benblogapp.herokuapp.com/' target="_blank" rel="noreferrer" className={classes.demoLink}>Demo</a>
            <a href='https://github.com/BenjacksonSE/blog-site' target="_blank" rel="noreferrer" className={classes.demoLink}>Github</a>
          </div>
        </div>
